...
static void gst_myvideo_scale_finalize (GstMyVideoScale * videoscale);
...
#define gst_myvideo_scale_parent_class parent_class
G_DEFINE_TYPE (GstMyVideoScale, gst_myvideo_scale, GST_TYPE_VIDEO_FILTER); //Works Perfect

static void
gst_myvideo_scale_class_init (GstMyVideoScaleClass * klass)
{
  ...
  gobject_class->finalize = (GObjectFinalizeFunc) gst_myvideo_scale_finalize;
  ...
  gst_element_class_set_static_metadata (element_class,
      "My Video scaler", "Filter/Converter/Video/Scaler",
...
static void
gst_myvideo_scale_init (GstMyVideoScale * videoscale)
{
...
static void
gst_myvideo_scale_finalize (GstMyVideoScale * videoscale)
{
...
gst_video_scale_set_property (GObject * object, guint prop_id,
    const GValue * value, GParamSpec * pspec)
{
  GstMyVideoScale *vscale = GST_VIDEO_SCALE (object);
    ...
    GstPadDirection direction, GstCaps * caps, GstCaps * filter)
{
  ...
  gint i, n;
  g_print("Inside gst_video_scale_transform_caps \n");
...
{
  GstMyVideoScale *videoscale = GST_VIDEO_SCALE (filter);
    ...
    GstCaps * caps, GstCaps * othercaps)
{
  ...
  GValue fpar = { 0, }, tpar = {
  0,};
  g_print("Inside gst_video_scale_fixate_caps \n");
...
{
  GstMyVideoScale *videoscale = GST_VIDEO_SCALE_CAST (filter);
...
{
  GstMyVideoScale *videoscale = GST_VIDEO_SCALE_CAST (trans);
