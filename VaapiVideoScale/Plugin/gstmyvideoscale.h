...
#ifndef __GST_MYVIDEO_SCALE_H__
#define __GST_MYVIDEO_SCALE_H__
...
#define GST_VIDEO_SCALE(obj) \
  (G_TYPE_CHECK_INSTANCE_CAST((obj),GST_TYPE_MYVIDEO_SCALE,GstMyVideoScale))
#define GST_VIDEO_SCALE_CLASS(klass) \
  (G_TYPE_CHECK_CLASS_CAST((klass),GST_TYPE_MYVIDEO_SCALE,GstVideoScaleClass))
#define GST_IS_VIDEO_SCALE(obj) \
  (G_TYPE_CHECK_INSTANCE_TYPE((obj),GST_TYPE_MYVIDEO_SCALE))
#define GST_IS_VIDEO_SCALE_CLASS(klass) \
  (G_TYPE_CHECK_CLASS_TYPE((klass),GST_TYPE_MYVIDEO_SCALE))
#define GST_VIDEO_SCALE_CAST(obj)       ((GstMyVideoScale *)(obj))
...
typedef struct _GstMyVideoScale GstMyVideoScale;
typedef struct _GstMyVideoScaleClass GstMyVideoScaleClass;
...
G_GNUC_INTERNAL GType gst_myvideo_scale_get_type (void) G_GNUC_INTERNAL;

//#define GST_VIDEO_CONVERTER_OPT_THREADS   "GstVideoConverter.threads"

G_END_DECLS

#endif /* __GST_MYVIDEO_SCALE_H__ */
